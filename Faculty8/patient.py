...
def add():
    ...
    try:
        ...
        db.insert(name_entry.get(), address_entry.get(), birthday_entry.get() , age_entry.get() ,phone_entry.get(), marital_combobox.get(),
                height_entry.get(),weight_entry.get(), pr_entry.get(),bt_entry.get(), home_entry.get(), work_entry.get())
...
home= ""
work= ""
home_entry = Entry(loginPanel, font=("Microsoft JhengHei", 11),textvariable= home, fg="#497687", width=24)
work_entry = Entry(loginPanel, font=("Microsoft JhengHei", 11),textvariable= work, fg="#497687", width=24)
displayAll()
root.mainloop()
